...
public class AddNewBookStockActivity extends AppCompatActivity {
    Button addNewBookNavigateButton;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_add_new_book_stock);
        ...
        addNewBookNavigateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AddNewBookStockActivity.this, AddNewBookActivity.class);
